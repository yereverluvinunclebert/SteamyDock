...
'
    ...
    iconFilename = App.Path & "\iconSettings\my collection\steampunk icons MKI" & "\folder-closed.png"
    If fFExists(iconFilename) Then
        IconImage = iconFilename
    Else
        IconImage = App.Path & "\iconSettings\Icons\help.png"
...
'---------------------------------------------------------------------------------------
'
Private Sub mnuMSSettingsStartupApps_Click()
    Dim IconImage As String
    Dim iconFilename As String
    
    ' check the icon exists
    On Error GoTo mnuMSSettingsStartupApps_Click_Error
    ...
    If fFExists(IconImage) Then
        '    thisFilename, thisTitle, thisCommand, thisArguments, thisWorkingDirectory)
        Call insertNewIconDataIntoCurrentPosition(IconImage, "Startup Apps", "start ms-settings:startupapps", vbNullString, vbNullString, vbNullString, vbNullString, vbNullString, vbNullString, vbNullString, vbNullString, vbNullString, vbNullString, vbNullString)
    ...
    Else
         '.11 DAEB 01/04/2021 menu.frm Replaced the modal msgbox with the non-modal form
         MessageBox Me.hWnd, "Unable to add Startup Apps image as it does not exist", "SteamyDock Confirmation Message", vbOKOnly + vbExclamation
         '        MsgBox "Unable to add shutdown image as it does not exist"
    End If
...
mnuMSSettingsStartupApps_Click_Error:

     MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure mnuMSSettingsStartupApps_Click of Form menuForm"
End Sub

'---------------------------------------------------------------------------------------
' Procedure : mnuMSSettingsVideoPlayback_Click
' Author    : beededea
' Date      : 26/06/2026
' Purpose   :
'---------------------------------------------------------------------------------------
'
Private Sub mnuMSSettingsVideoPlayback_Click()
    Dim IconImage As String
    Dim iconFilename As String
    
    ' check the icon exists
    On Error GoTo mnuMSSettingsVideoPlayback_Click_Error
    ...
    Else
         '.11 DAEB 01/04/2021 menu.frm Replaced the modal msgbox with the non-modal form
         MessageBox Me.hWnd, "Unable to add VideoPlayback image as it does not exist", "SteamyDock Confirmation Message", vbOKOnly + vbExclamation
         '        MsgBox "Unable to add shutdown image as it does not exist"
    End If
...
mnuMSSettingsVideoPlayback_Click_Error:

     MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure mnuMSSettingsVideoPlayback_Click of Form menuForm"
End Sub

'---------------------------------------------------------------------------------------
' Procedure : mnuMSSettingsControlCenter_Click
' Author    : beededea
' Date      : 26/06/2026
' Purpose   :
'---------------------------------------------------------------------------------------
'
Private Sub mnuMSSettingsControlCenter_Click()
    Dim IconImage As String
    Dim iconFilename As String
    
    ' check the icon exists
    On Error GoTo mnuMSSettingsControlCenter_Click_Error
    ...
    Else
         '.11 DAEB 01/04/2021 menu.frm Replaced the modal msgbox with the non-modal form
         MessageBox Me.hWnd, "Unable to add ControlCenter image as it does not exist", "SteamyDock Confirmation Message", vbOKOnly + vbExclamation
         '        MsgBox "Unable to add shutdown image as it does not exist"
    End If
...
mnuMSSettingsControlCenter_Click_Error:

     MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure mnuMSSettingsControlCenter_Click of Form menuForm"
End Sub

'---------------------------------------------------------------------------------------
' Procedure : mnuMSSettingsBluetooth_Click
' Author    : beededea
' Date      : 26/06/2026
' Purpose   :
'---------------------------------------------------------------------------------------
'
Private Sub mnuMSSettingsBluetooth_Click()
    Dim IconImage As String
    Dim iconFilename As String
    
    ' check the icon exists
    On Error GoTo mnuMSSettingsBluetooth_Click_Error
...
mnuMSSettingsBluetooth_Click_Error:

     MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure mnuMSSettingsBluetooth_Click of Form menuForm"
End Sub

'---------------------------------------------------------------------------------------
' Procedure : mnuMSSettingsCamera_Click
' Author    : beededea
' Date      : 26/06/2026
' Purpose   :
'---------------------------------------------------------------------------------------
'
Private Sub mnuMSSettingsCamera_Click()
    Dim IconImage As String
    Dim iconFilename As String
    
    ' check the icon exists
    On Error GoTo mnuMSSettingsCamera_Click_Error
    ...
    Else
         '.11 DAEB 01/04/2021 menu.frm Replaced the modal msgbox with the non-modal form
         MessageBox Me.hWnd, "Unable to add Camera image as it does not exist", "SteamyDock Confirmation Message", vbOKOnly + vbExclamation
         '        MsgBox "Unable to add shutdown image as it does not exist"
    End If
...
mnuMSSettingsCamera_Click_Error:

     MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure mnuMSSettingsCamera_Click of Form menuForm"
End Sub

'---------------------------------------------------------------------------------------
' Procedure : mnuMSSettingsMouseTouchpad_Click
' Author    : beededea
' Date      : 26/06/2026
' Purpose   :
'---------------------------------------------------------------------------------------
'
Private Sub mnuMSSettingsMouseTouchpad_Click()
    Dim IconImage As String
    Dim iconFilename As String
    
    ' check the icon exists
    On Error GoTo mnuMSSettingsMouseTouchpad_Click_Error
    ...
    Else
         '.11 DAEB 01/04/2021 menu.frm Replaced the modal msgbox with the non-modal form
         MessageBox Me.hWnd, "Unable to add MouseTouchpad image as it does not exist", "SteamyDock Confirmation Message", vbOKOnly + vbExclamation
         '        MsgBox "Unable to add shutdown image as it does not exist"
    End If
...
mnuMSSettingsMouseTouchpad_Click_Error:

     MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure mnuMSSettingsMouseTouchpad_Click of Form menuForm"
End Sub

'---------------------------------------------------------------------------------------
' Procedure : mnuMSSettingsPrinters_Click
' Author    : beededea
' Date      : 26/06/2026
' Purpose   :
'---------------------------------------------------------------------------------------
'
Private Sub mnuMSSettingsPrinters_Click()
    Dim IconImage As String
    Dim iconFilename As String
    
    ' check the icon exists
    On Error GoTo mnuMSSettingsPrinters_Click_Error
...
mnuMSSettingsPrinters_Click_Error:

     MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure mnuMSSettingsPrinters_Click of Form menuForm"
End Sub
...
'---------------------------------------------------------------------------------------
'
Private Sub mnuMSSettingsDevicesTouch_Click()
    Dim IconImage As String
    Dim iconFilename As String
    
    ' check the icon exists
    On Error GoTo mnuMSSettingsDevicesTouch_Click_Error
    ...
    Else
         '.11 DAEB 01/04/2021 menu.frm Replaced the modal msgbox with the non-modal form
         MessageBox Me.hWnd, "Unable to add DevicesTouch image as it does not exist", "SteamyDock Confirmation Message", vbOKOnly + vbExclamation
         '        MsgBox "Unable to add shutdown image as it does not exist"
    End If
...
mnuMSSettingsDevicesTouch_Click_Error:

     MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure mnuMSSettingsDevices-Touch_Click of Form menuForm"
End Sub

'---------------------------------------------------------------------------------------
' Procedure : mnuMSSettingsUSB_Click
' Author    : beededea
' Date      : 26/06/2026
' Purpose   :
'---------------------------------------------------------------------------------------
'
Private Sub mnuMSSettingsUSB_Click()
    Dim IconImage As String
    Dim iconFilename As String
    
    ' check the icon exists
    On Error GoTo mnuMSSettingsUSB_Click_Error
    ...
    Else
         '.11 DAEB 01/04/2021 menu.frm Replaced the modal msgbox with the non-modal form
         MessageBox Me.hWnd, "Unable to add USB image as it does not exist", "SteamyDock Confirmation Message", vbOKOnly + vbExclamation
         '        MsgBox "Unable to add shutdown image as it does not exist"
    End If
...
mnuMSSettingsUSB_Click_Error:

     MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure mnuMSSettingsUSB_Click of Form menuForm"
End Sub

'---------------------------------------------------------------------------------------
' Procedure : mnuMSSettingsNetworkStatus_Click
' Author    : beededea
' Date      : 26/06/2026
' Purpose   :
'---------------------------------------------------------------------------------------
'
Private Sub mnuMSSettingsNetworkStatus_Click()
    Dim IconImage As String
    Dim iconFilename As String
    
    ' check the icon exists
    On Error GoTo mnuMSSettingsNetworkStatus_Click_Error
    ...
    Else
         '.11 DAEB 01/04/2021 menu.frm Replaced the modal msgbox with the non-modal form
         MessageBox Me.hWnd, "Unable to add Network-Status image as it does not exist", "SteamyDock Confirmation Message", vbOKOnly + vbExclamation
         '        MsgBox "Unable to add shutdown image as it does not exist"
    End If
...
mnuMSSettingsNetworkStatus_Click_Error:

     MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure mnuMSSettingsNetwork-Status_Click of Form menuForm"
End Sub

'---------------------------------------------------------------------------------------
' Procedure : mnuMSSettingsAdvancedSettings_Click
' Author    : beededea
' Date      : 26/06/2026
' Purpose   :
'---------------------------------------------------------------------------------------
'
Private Sub mnuMSSettingsAdvancedSettings_Click()
    Dim IconImage As String
    Dim iconFilename As String
    
    ' check the icon exists
    On Error GoTo mnuMSSettingsAdvancedSettings_Click_Error
    ...
    Else
         '.11 DAEB 01/04/2021 menu.frm Replaced the modal msgbox with the non-modal form
         MessageBox Me.hWnd, "Unable to add AdvancedSettings image as it does not exist", "SteamyDock Confirmation Message", vbOKOnly + vbExclamation
         '        MsgBox "Unable to add shutdown image as it does not exist"
    End If
...
mnuMSSettingsAdvancedSettings_Click_Error:

     MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure mnuMSSettingsAdvancedSettings_Click of Form menuForm"
End Sub


'---------------------------------------------------------------------------------------
' Procedure : mnuMSSettingsNetwork-Ethernet_Click
' Author    : beededea
' Date      : 26/06/2026
' Purpose   :
'---------------------------------------------------------------------------------------
'
Private Sub mnuMSSettingsNetworkEthernet_Click()
    Dim IconImage As String
    Dim iconFilename As String
    
    ' check the icon exists
    On Error GoTo mnuMSSettingsNetworkEthernet_Click_Error
    ...
    Else
         '.11 DAEB 01/04/2021 menu.frm Replaced the modal msgbox with the non-modal form
         MessageBox Me.hWnd, "Unable to add Network-Ethernet image as it does not exist", "SteamyDock Confirmation Message", vbOKOnly + vbExclamation
         '        MsgBox "Unable to add shutdown image as it does not exist"
    End If
...
mnuMSSettingsNetworkEthernet_Click_Error:

     MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure mnuMSSettingsNetworkEthernet_Click of Form menuForm"
End Sub

'---------------------------------------------------------------------------------------
' Procedure : mnuMSSettingsNetwork-Wifi_Click
' Author    : beededea
' Date      : 26/06/2026
' Purpose   :
'---------------------------------------------------------------------------------------
'
Private Sub mnuMSSettingsNetworkWifi_Click()
    Dim IconImage As String
    Dim iconFilename As String
    
    ' check the icon exists
    On Error GoTo mnuMSSettingsNetworkWifi_Click_Error
    ...
    Else
         '.11 DAEB 01/04/2021 menu.frm Replaced the modal msgbox with the non-modal form
         MessageBox Me.hWnd, "Unable to add Network-Wifi image as it does not exist", "SteamyDock Confirmation Message", vbOKOnly + vbExclamation
         '        MsgBox "Unable to add shutdown image as it does not exist"
    End If
...
mnuMSSettingsNetworkWifi_Click_Error:

     MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure mnuMSSettingsNetwork-Wifi_Click of Form menuForm"
End Sub



'---------------------------------------------------------------------------------------
' Procedure : mnuMSSettingsThemes_Click
' Author    : beededea
' Date      : 26/06/2026
' Purpose   :
'---------------------------------------------------------------------------------------
'
Private Sub mnuMSSettingsThemes_Click()
    Dim IconImage As String
    Dim iconFilename As String
    
    ' check the icon exists
    On Error GoTo mnuMSSettingsThemes_Click_Error
    ...
    Else
         '.11 DAEB 01/04/2021 menu.frm Replaced the modal msgbox with the non-modal form
         MessageBox Me.hWnd, "Unable to add Themes image as it does not exist", "SteamyDock Confirmation Message", vbOKOnly + vbExclamation
         '        MsgBox "Unable to add shutdown image as it does not exist"
    End If
...
mnuMSSettingsThemes_Click_Error:

     MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure mnuMSSettingsThemes_Click of Form menuForm"
End Sub


'---------------------------------------------------------------------------------------
' Procedure : mnuMSSettingsDeviceUsage_Click
' Author    : beededea
' Date      : 26/06/2026
' Purpose   :
'---------------------------------------------------------------------------------------
'
Private Sub mnuMSSettingsDeviceUsage_Click()
    Dim IconImage As String
    Dim iconFilename As String
    
    ' check the icon exists
    On Error GoTo mnuMSSettingsDeviceUsage_Click_Error
    ...
    Else
         '.11 DAEB 01/04/2021 menu.frm Replaced the modal msgbox with the non-modal form
         MessageBox Me.hWnd, "Unable to add DeviceUsage image as it does not exist", "SteamyDock Confirmation Message", vbOKOnly + vbExclamation
         '        MsgBox "Unable to add shutdown image as it does not exist"
    End If
...
mnuMSSettingsDeviceUsage_Click_Error:

     MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure mnuMSSettingsDeviceUsage_Click of Form menuForm"
End Sub



'---------------------------------------------------------------------------------------
' Procedure : mnuMSSettingsDisplayAdvanced_Click
' Author    : beededea
' Date      : 26/06/2026
' Purpose   :
'---------------------------------------------------------------------------------------
'
Private Sub mnuMSSettingsDisplayAdvanced_Click()
    Dim IconImage As String
    Dim iconFilename As String
    
    ' check the icon exists
    On Error GoTo mnuMSSettingsDisplayAdvanced_Click_Error
    ...
    Else
         '.11 DAEB 01/04/2021 menu.frm Replaced the modal msgbox with the non-modal form
         MessageBox Me.hWnd, "Unable to add DisplayAdvanced image as it does not exist", "SteamyDock Confirmation Message", vbOKOnly + vbExclamation
         '        MsgBox "Unable to add shutdown image as it does not exist"
    End If
...
mnuMSSettingsDisplayAdvanced_Click_Error:

     MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure mnuMSSettingsDisplayAdvanced_Click of Form menuForm"
End Sub


'---------------------------------------------------------------------------------------
' Procedure : mnuMSSettingsAppsVolume_Click
' Author    : beededea
' Date      : 26/06/2026
' Purpose   :
'---------------------------------------------------------------------------------------
'
Private Sub mnuMSSettingsAppsVolume_Click()
    Dim IconImage As String
    Dim iconFilename As String
    
    ' check the icon exists
    On Error GoTo mnuMSSettingsAppsVolume_Click_Error
    ...
    Else
         '.11 DAEB 01/04/2021 menu.frm Replaced the modal msgbox with the non-modal form
         MessageBox Me.hWnd, "Unable to add AppsVolume image as it does not exist", "SteamyDock Confirmation Message", vbOKOnly + vbExclamation
         '        MsgBox "Unable to add shutdown image as it does not exist"
    End If
...
mnuMSSettingsAppsVolume_Click_Error:

     MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure mnuMSSettingsAppsVolume_Click of Form menuForm"
End Sub


'---------------------------------------------------------------------------------------
' Procedure : mnuMSSettingsBatterySaverUsageDetails_Click
' Author    : beededea
' Date      : 26/06/2026
' Purpose   :
'---------------------------------------------------------------------------------------
'
Private Sub mnuMSSettingsBatterySaverUsageDetails_Click()
    Dim IconImage As String
    Dim iconFilename As String
    
    ' check the icon exists
    On Error GoTo mnuMSSettingsBatterySaverUsageDetails_Click_Error
    ...
    If fFExists(IconImage) Then
        '    thisFilename, thisTitle, thisCommand, thisArguments, thisWorkingDirectory)
        Call insertNewIconDataIntoCurrentPosition(IconImage, "BatterySaverUsageDetails", "start ms-settings:batterysaver-usagedetails", vbNullString, vbNullString, vbNullString, vbNullString, vbNullString, vbNullString, vbNullString, vbNullString, vbNullString, vbNullString, vbNullString)
        Call addImageToDictionaryAndCheckForRunningProcess(IconImage, "BatterySaverUsageDetails")
    ...
    Else
         '.11 DAEB 01/04/2021 menu.frm Replaced the modal msgbox with the non-modal form
         MessageBox Me.hWnd, "Unable to add BatterySaverUsageDetails image as it does not exist", "SteamyDock Confirmation Message", vbOKOnly + vbExclamation
         '        MsgBox "Unable to add shutdown image as it does not exist"
    End If
...
mnuMSSettingsBatterySaverUsageDetails_Click_Error:

     MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure mnuMSSettingsBatterySaverUsageDetails_Click of Form menuForm"
End Sub


'---------------------------------------------------------------------------------------
' Procedure : mnuMSSettingsDisplay_Click
' Author    : beededea
' Date      : 26/06/2026
' Purpose   :
'---------------------------------------------------------------------------------------
'
Private Sub mnuMSSettingsDisplay_Click()
    Dim IconImage As String
    Dim iconFilename As String
    
    ' check the icon exists
    On Error GoTo mnuMSSettingsDisplay_Click_Error
...
mnuMSSettingsDisplay_Click_Error:

     MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure mnuMSSettingsDisplay_Click of Form menuForm"
End Sub
...
'---------------------------------------------------------------------------------------
' Procedure : mnuMSSettingsPowerSleep_Click
' Author    : beededea
' Date      : 26/06/2026
' Purpose   :
'---------------------------------------------------------------------------------------
'
Private Sub mnuMSSettingsPowerSleep_Click()
    Dim IconImage As String
    Dim iconFilename As String
    
    ' check the icon exists
    On Error GoTo mnuMSSettingsPowerSleep_Click_Error
    ...
    Else
         '.11 DAEB 01/04/2021 menu.frm Replaced the modal msgbox with the non-modal form
         MessageBox Me.hWnd, "Unable to add PowerSleep image as it does not exist", "SteamyDock Confirmation Message", vbOKOnly + vbExclamation
         '        MsgBox "Unable to add shutdown image as it does not exist"
    End If
...
mnuMSSettingsPowerSleep_Click_Error:

     MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure mnuMSSettingsPowerSleep_Click of Form menuForm"
End Sub
...
'---------------------------------------------------------------------------------------
' Procedure : mnuMSSettingsSound_Click
' Author    : beededea
' Date      : 26/06/2026
' Purpose   :
'---------------------------------------------------------------------------------------
'
Private Sub mnuMSSettingsSound_Click()
    Dim IconImage As String
    Dim iconFilename As String
    
    ' check the icon exists
    On Error GoTo mnuMSSettingsSound_Click_Error
...
mnuMSSettingsSound_Click_Error:

     MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure mnuMSSettingsSound_Click of Form menuForm"
End Sub
...
'---------------------------------------------------------------------------------------
' Procedure : mnuMSSettingsDisksAndVolumes_Click
' Author    : beededea
' Date      : 26/06/2026
' Purpose   :
'---------------------------------------------------------------------------------------
'
Private Sub mnuMSSettingsDisksAndVolumes_Click()
    Dim IconImage As String
    Dim iconFilename As String
    
    ' check the icon exists
    On Error GoTo mnuMSSettingsDisksAndVolumes_Click_Error
...
mnuMSSettingsDisksAndVolumes_Click_Error:

     MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure mnuMSSettingsDisksAndVolumes_Click of Form menuForm"
End Sub
...
Public Sub mnuIconSettings_Click_Event()
    ...
    ' .15 DAEB 01/04/2021 menu.frm make changes for running in the IDE
    On Error GoTo mnuIconSettings_Click_Event_Error
...
mnuIconSettings_Click_Event_Error:

     MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure mnuIconSettings_Click_Event of Form menuForm"
...
'---------------------------------------------------------------------------------------
' Procedure : mnuSettingsAppsFeatures_Click
' Author    : beededea
' Date      : 26/06/2026
' Purpose   :
'---------------------------------------------------------------------------------------
'
Private Sub mnuSettingsAppsFeatures_Click()
    Dim IconImage As String
    Dim iconFilename As String
    
    On Error GoTo mnuSettingsAppsFeatures_Click_Error
    ...
    If fFExists(IconImage) Then
        '    thisFilename, thisTitle, thisCommand, thisArguments, thisWorkingDirectory)
        Call insertNewIconDataIntoCurrentPosition(IconImage, "Apps & Features", "start ms-settings:appsfeatures", vbNullString, vbNullString, vbNullString, vbNullString, vbNullString, vbNullString, vbNullString, vbNullString, vbNullString, vbNullString, vbNullString)
        Call addImageToDictionaryAndCheckForRunningProcess(IconImage, "Apps & Features")
    ...
    Else
         '.11 DAEB 01/04/2021 menu.frm Replaced the modal msgbox with the non-modal form
         MessageBox Me.hWnd, "Unable to add Apps & Features image as it does not exist", "SteamyDock Confirmation Message", vbOKOnly + vbExclamation
         '        MsgBox "Unable to add shutdown image as it does not exist"
    End If
...
mnuSettingsAppsFeatures_Click_Error:

     MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure mnuSettingsAppsFeatures_Click of Form menuForm"
End Sub



'---------------------------------------------------------------------------------------
' Procedure : mnuSettingsOtherusers_Click
' Author    : beededea
' Date      : 26/06/2026
' Purpose   :
'---------------------------------------------------------------------------------------
'
Private Sub mnuSettingsOtherusers_Click()
    Dim IconImage As String
    Dim iconFilename As String
    
    On Error GoTo mnuSettingsOtherusers_Click_Error
    
    ' check the icon exists
    iconFilename = App.Path & "\iconSettings\my collection\steampunk icons MKI" & "\patersons-camp-coffee.ico"
    If fFExists(iconFilename) Then
        IconImage = iconFilename
    Else
        IconImage = App.Path & "\iconSettings\Icons\help.png"
    ...
    If fFExists(IconImage) Then
        '    thisFilename, thisTitle, thisCommand, thisArguments, thisWorkingDirectory)
        Call insertNewIconDataIntoCurrentPosition(IconImage, "Other Users", "start ms-settings:otherusers", vbNullString, vbNullString, vbNullString, vbNullString, vbNullString, vbNullString, vbNullString, vbNullString, vbNullString, vbNullString, vbNullString)
        Call addImageToDictionaryAndCheckForRunningProcess(IconImage, "Other Users")
    ...
    Else
         '.11 DAEB 01/04/2021 menu.frm Replaced the modal msgbox with the non-modal form
         MessageBox Me.hWnd, "Unable to add Other Users image as it does not exist", "SteamyDock Confirmation Message", vbOKOnly + vbExclamation
         '        MsgBox "Unable to add shutdown image as it does not exist"
    End If
...
mnuSettingsOtherusers_Click_Error:

     MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure mnuSettingsOtherusers_Click of Form menuForm"
End Sub
