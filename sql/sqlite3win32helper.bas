...
Public Const SQLITE_INDEX_CONSTRAINT_LIMIT As Long = 73
Public Const SQLITE_INDEX_CONSTRAINT_OFFSET As Long = 74
...
Public Const SQLITE_STMTSTATUS_FILTER_MISS As Long = 7
Public Const SQLITE_STMTSTATUS_FILTER_HIT As Long = 8
